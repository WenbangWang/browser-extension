import IFrameStateController from '../../src/content-script/IFrameStateController'
...
describe('IFrameStateController', () => {
  ...
  describe('exists', () => {
    ...
    it('should return true if id exists in document', () => {
      ...
      expect(iframeStateController.exists()).to.be.true // eslint-disable-line no-unused-expressions
    })

    it('should return false if id does not exist in document', () => {
      document.getElementById.returns()

      expect(iframeStateController.exists()).to.be.false // eslint-disable-line no-unused-expressions
    })
  })
  ...
  describe('show', () => {
    ...
    it('should check the existence', () => {
      ...
      iframeStateController.exists.should.have.been.called // eslint-disable-line no-unused-expressions
    })

    it('should not build new iframe if iframe exists', () => {
      iframeStateController.exists.returns(true)

      iframeStateController.show()

      iframeBuilder.build.should.not.have.been.called // eslint-disable-line no-unused-expressions
    })
    ...
    describe('iframe does not exist', () => {
      ...
      it('should build a new iframe', () => {
        ...
        iframeBuilder.build.should.have.been.called // eslint-disable-line no-unused-expressions
      })
  ...
  describe('toggle', () => {
    ...
    it('should close it if iframe exists', () => {
      ...
      iframeStateController.close.should.have.been.called // eslint-disable-line no-unused-expressions
    })
    ...
    it('should show it if iframe does not exist', () => {
      ...
      iframeStateController.show.should.have.been.called // eslint-disable-line no-unused-expressions
    })
  })
})
